...
class LoginView extends StatefulWidget {
  ...
  const LoginView({required this.onSwitchToRegister, super.key});
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Center(child: Text('VAIL', style: VailTheme.display)),
                ...
                if (auth.isLoading)
                  ...
                  SizedBox(
                    ...
                    child: VailButton.primary(label: 'SIGN IN', onTap: _submit),
                  ),
                if (auth.error.isNotEmpty) ...[
                  const SizedBox(height: VailTheme.md),
                  Text(auth.error, style: VailTheme.bodySmall.copyWith(color: VailTheme.error), textAlign: TextAlign.center),
                ],
                const SizedBox(height: VailTheme.xl),
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Text("Don't have an account?", style: VailTheme.bodySmall),
                    TextButton(
                      onPressed: widget.onSwitchToRegister,
                      child: Text('Create one', style: VailTheme.bodySmall.copyWith(color: VailTheme.primary)),
                    ),
                  ],
                ),
              ],
