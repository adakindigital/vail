...
/// Desktop settings UI — two-column layout, no status-bar padding.
  ...
  Widget build(BuildContext context) {
    return const Row(
      ...
      children: [
        ...
        VerticalDivider(width: 1, color: VailTheme.border),
...
class _SectionLabel extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Text(text, style: VailTheme.sectionLabel);
  }
}
